...
- 📖 Daily reading — a chapter of Proverbs by the date and a Psalm that walks through the book and starts over, on the Today screen and expandable to a full-page reader. Ships with the public-domain World English Bible; add a free NLT key in Settings to read the New Living Translation instead (see `server/scripture/README.md` for why the NLT is not bundled)
